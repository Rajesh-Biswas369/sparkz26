...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center relative overflow-hidden px-4 pt-16">
      ...
      <div className="z-10 w-full max-w-md bg-black/40 backdrop-blur-md border border-white/10 rounded-2xl p-8 md:p-10 shadow-2xl relative">
        <h1
        ...
        <form className="space-y-6 flex flex-col" autoComplete="off">
          ...
          <button
            type="submit"
            className="w-full bg-[#00E5FF] text-black font-bold text-lg py-4 mt-2 transition-transform hover:scale-[1.02] active:scale-95"
            style={{
              clipPath:
